...
readTime: "12 pages"
keyFindings:
  - "[PLACEHOLDER] Key finding one — replace with a real takeaway from the paper."
  - "[PLACEHOLDER] Key finding two — replace with a real takeaway from the paper."
  - "[PLACEHOLDER] Key finding three — replace with a real takeaway from the paper."
